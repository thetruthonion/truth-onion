...
// The tier color tokens — SINGLE SOURCE OF TRUTH. The design authority
// behind these values is archived in the build supervision workstream, not
// this repository; this file carries every constraint that matters here.
//
